...
br_s <- br_s[br_s$typ_informacji == "udział w pozycji ogółem [%]", ]
...
ggplot() +
  ...
  labs(title = "Struktura nakładów na działalność B+R według sektorów wykonawczych - udział procentowy", x = "Rok", y = "Udział [%]") +
  scale_color_manual(
    name = "Sektory",
